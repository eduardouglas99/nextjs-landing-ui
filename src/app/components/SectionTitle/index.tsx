...
export default function SectionTitle({
  ...
  return (
    <h1 className={twMerge("text-[32px] font-bold md:text-[56px] sm:font-extrabold text-slate-900 tracking-tight leading-[110%] flex flex-wrap gap-x-1 md:gap-x-2", className)}>
